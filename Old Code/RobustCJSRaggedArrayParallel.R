...
### See model code in "robust_CJS_phi_dot_p_dot_c_dot.bug"
...
date()
Z2.rcjs.all.constant=jags.parallel(data=bugs.data,inits,parameters,"robust_CJS_phi_dot_p_dot_c_dot.bug",n.chains=3,n.thin=6,n.iter=10000,n.burnin=5000)
date() # 51 min
