...
#-----------------To Do------------------------------------------#
# 1) figure out how to deal with unknown serostatus
#     Could assume unknowns are negative for phi
#     But want to exclude them from psi calculation
...
cat("
    ...
    # STATE PROCESS
    for (i in 1:nind){
      # Define latent state at first occasion  ## don't think this is right - this is for measuring recruitment?
