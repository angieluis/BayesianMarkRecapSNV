...
cat("
    ...
    for (t in 1:(n.primary.occasions-1)){
      ...
      psiSI[i,t] <- mean.beta*I.dat[t-1] 
        # really should calculate I here based on p (num.caught/p). but I think there will be estimation problems, so for now, I'll go with using MNI. I think the data will have to go in as centered and scaled.
