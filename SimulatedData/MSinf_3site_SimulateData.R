...
#      6) to get Idat, calc MNI from obs, and divide by 100 (to standardize)
#         close to but not the same as used on simulation (actual z I)
######################################################################
...
save(obs.dat, covariate.data, monthlyCH, n.sec.occ, p.or.c, months.trapped.mat, length.months.trapped,file="SimulatedData/CombinedSimMSDatasimpler2.RData")
