...
c <- rep(0.5, n.prim.occasions)               # recapture in same primary session
...
cat("
 ...
 ######### need to add c to this with ifelse somehow
...
date() # took 1.5 hours, uh oh. slow because not specifying known state?
